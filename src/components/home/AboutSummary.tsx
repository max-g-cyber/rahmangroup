    ...
    <section className="py-2 sm:py-24">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
          <div>
            <h2 className="mt-2 text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl text-center">A Legacy of Trust Since 1996</h2>
          ...
          <div className="rounded-lg bg-gray-50 p-8 ring-1 ring-gray-900/5">
            ...
            <ul className="mt-6 space-y-4">
              <li className="flex gap-x-3">
                ...
                <span className="text-base text-gray-700"> <span className="font-semibold text-zinc-900">COMMITMENT</span></span>
              </li>
              <li className="flex gap-x-3">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-brand text-sm font-bold text-white">2</span>
                <span className="text-base text-gray-700"> <span className="font-semibold text-zinc-900">SWIFT SERVICE</span></span>
              </li>
              <li className="flex gap-x-3">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-brand text-sm font-bold text-white">3</span>
                <span className="text-base text-gray-700"> <span className="font-semibold text-zinc-900">REPUTATION</span></span>
              </li>
              <li className="flex gap-x-3">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-brand text-sm font-bold text-white">4</span>
                <span className="text-base text-gray-700"><span className="font-semibold text-zinc-900">QUALITY</span></span>
              </li>
            </ul>
          </div>
        </div>
